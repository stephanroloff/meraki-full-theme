...
function scripts_and_styles_editor(){   
   ...
   wp_enqueue_script('main_js_editor', get_theme_file_uri('/build/editor.js'), array('jquery','wp-element', 'wp-editor', 'wp-blocks'), '1.0', true );
}

function scripts_and_styles_frontend(){   
   wp_enqueue_style('main_style_frontend', get_theme_file_uri('/build/frontend.css'));
   wp_enqueue_script('main_js_frontend', get_theme_file_uri('/build/frontend.js'), array('jquery'), '1.0', true );
}
